"""
Django settings for cook_recipe project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'make_shorter': 'website.templatetags.make_shorter',
            }
        },
    },
]

WSGI_APPLICATION = 'cook_recipe.wsgi.application'
